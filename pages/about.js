                    ...
                    <div className="grid grid-cols-3 gap-16">
                      ...
                      <div className="md:pr-8 col-span-2">
                        ...
                        <p className="text-lg block text-slate-500 mb-4">My journey into product management started like everyone else... not in product! I spent 
                           many years in academia studying animals (coots! lizards! damselfies!) and human evolution. I've got some pretty silly bonobo stories 
                           if you'd like to hear them. </p>
                        <p className="text-lg block text-slate-500 mb-4">My introduction into the was through data science. I learned a lot about how tech companies work but mostly that I wanted more of a say on what we decided to build, 
                           not just the how. And so I moved into product management! And here we are!</p>

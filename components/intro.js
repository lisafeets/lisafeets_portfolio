  ...
  return (
    <section className="flex-col md:flex-row flex items-center md:justify-between mt-16 mb-16 md:mb-12">
      <div className="md:pr-8">
        ...
        <p className="text-2xl block text-slate-500">I build innovative products that solve critical business challenges — spanning marketing optimization, healthcare verification, and team development 💡</p>
